...
(
    (SELECT id FROM pelatihan WHERE judul_pelatihan LIKE '%Manajemen Kandang Dasar%'),
...
(
    (SELECT id FROM pelatihan WHERE judul_pelatihan LIKE '%Kesehatan Unggas Praktis%'),
...
(
    (SELECT id FROM pelatihan WHERE judul_pelatihan LIKE '%Kewirausahaan Peternakan%'),
